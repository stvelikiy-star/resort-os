...
const COPY = {
  ru: {
    ...
    servicesIntro: "Информация берётся из единого каталога отеля. На следующем операционном шаге заявки из этих разделов будут уходить напрямую в PMS персоналу.",
  ...
  kg: {
    ...
    servicesIntro: "Маалымат мейманкананын бирдиктүү каталогунан алынат. Кийинки операциялык этапта бул жерден түзүлгөн өтүнмөлөр PMS аркылуу кызматкерлерге жетет.",
    contact: "Администратор",
  ...
  en: {
    ...
    servicesIntro: "Information comes from the hotel’s single approved service catalogue. The next operational stage will route requests from here directly into the PMS staff workflow.",

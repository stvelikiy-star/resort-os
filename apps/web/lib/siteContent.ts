...
export const fallbackSiteContent: Record<SiteLocale, SiteContent> = {
  ru: {
    ...
    contacts: { phone: "+996 558 08 50 02", whatsapp: "+996 558 08 50 08", email: "3koronykg@mail.ru", address: "Иманбай Молдо, Чолпон-Ата 722315, Кыргызстан" },
    seo: { title: "Три Короны — Resort & SPA на Иссык-Куле", description: "Три Короны Resort & SPA в Чолпон-Ате: 84 номера, 12 категорий, собственный пляж, пирс 150 м, SPA и открытый бассейн." },
  },
  kg: {
    ...
    contacts: { phone: "+996 558 08 50 02", whatsapp: "+996 558 08 50 08", email: "3koronykg@mail.ru", address: "Иманбай Молдо, Чолпон-Ата 722315, Кыргызстан" },
    seo: { title: "Үч Таажы — Ысык-Көлдөгү Resort & SPA", description: "Чолпон-Атадагы Үч Таажы Resort & SPA: 84 номер, 12 категория, өз пляжы, 150 м пирс, SPA жана ачык бассейн." },
  },
  en: {
    ...
    contacts: { phone: "+996 558 08 50 02", whatsapp: "+996 558 08 50 08", email: "3koronykg@mail.ru", address: "Imanbay Moldo, Cholpon-Ata 722315, Kyrgyzstan" },
    seo: { title: "Three Crowns — Resort & SPA on Issyk-Kul", description: "Three Crowns Resort & SPA in Cholpon-Ata: 84 rooms, 12 categories, private beach, 150 m pier, SPA and outdoor pool." },
  },
};

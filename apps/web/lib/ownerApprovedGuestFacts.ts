  ...
  ru: {
    ...
    services: {
      ...
      cards: [
        ...
        { code: "PARKING", title: "Парковка", text: "Для проживающих парковка бесплатная. Ориентировочная вместимость — 30–50 автомобилей." },
        ...
        { code: "EXCURSIONS", title: "Экскурсии и туры", text: "Экскурсии и туры доступны по запросу. Актуальную программу, цену и доступность подтверждает менеджер; новый прайс будет опубликован после утверждения.", cta: "Уточнить программу", href: transferHref("Здравствуйте! Хочу узнать актуальные экскурсии и туры от «Трёх Корон».") },
  ...
  kg: {
    ...
    services: {
      ...
      cards: [
        ...
        { code: "PARKING", title: "Унаа токтотуучу жай", text: "Жашоочулар үчүн акысыз. Болжолдуу сыйымдуулугу — 30–50 унаа." },
        ...
        { code: "EXCURSIONS", title: "Экскурсиялар жана турлар", text: "Суроо боюнча жеткиликтүү. Учурдагы программа, баа жана жеткиликтүүлүктү менеджер ырастайт; жаңы прайс бекитилгенден кийин жарыяланат.", cta: "Программаны тактоо", href: transferHref("Саламатсызбы! «Үч Таажыдан» актуалдуу экскурсиялар жана турлар тууралуу маалымат керек.") },
  ...
  en: {
    ...
    services: {
      ...
      cards: [
        ...
        { code: "PARKING", title: "Parking", text: "Free for staying guests. Approximate capacity: 30–50 vehicles." },
        ...
        { code: "EXCURSIONS", title: "Excursions and tours", text: "Available on request. The manager confirms the current programme, price and availability; a new price list will be published after approval.", cta: "Ask about tours", href: transferHref("Hello! I would like to know the current excursions and tours available from Three Crowns.") },

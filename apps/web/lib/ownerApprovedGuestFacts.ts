  ...
  en: {
    ...
    services: {
      ...
      cards: [
        ...
        { code: "EXCURSIONS", title: "Issyk-Kul tours · 2026 season", text: "Selected routes from partner MIX TOUR.KG: Semenovskoye Gorge + hot spring — 2,000 KGS/person; Jeti-Oguz + hot spring — 3,500; Dead Lake + hot spring — 3,000; Barskoon waterfall + Skazka Gorge + Jeti-Oguz + Karakol (church and mosque) + hot spring — 4,500 KGS/person. Departures run daily from 20 June to 25 August 2026. Transfer and guide services are included; admission tickets, hot-spring entry, meals and other additional expenses are paid separately.", cta: "Choose a tour", href: transferHref("Hello! I would like to choose an Issyk-Kul excursion or tour during my stay at Three Crowns.") },

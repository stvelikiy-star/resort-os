...
export const metadata: Metadata = {
  ...
  description: "Три Короны Resort & SPA в Чолпон-Ате: 84 номера, 12 категорий, собственный пляж, 150-метровый пирс, SPA, открытый бассейн, семейный отдых и групповые заезды.",

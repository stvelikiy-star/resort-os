...
export default function HomePage() {
  return <>
    ...
    <main id="top">
      ...
      <section className="section amenities-section" aria-labelledby="amenities-title"><div className="wrap"><div className="section-heading compact"><div><p className="eyebrow">Подтверждённые факты</p><h2 className="display-title" id="amenities-title">Главное для отдыха</h2></div><p className="section-aside">Показываем только услуги и инфраструктуру, закреплённые в текущем canonical состоянии проекта. Новые медиаматериалы сами по себе не повышают неподтверждённые возможности до публичного факта.</p></div><div className="amenity-list"><article><span>01</span><h3>Собственный пляж</h3></article><article><span>02</span><h3>Пирс 150 м</h3></article><article><span>03</span><h3>SPA и массаж</h3></article><article><span>04</span><h3>Открытый бассейн 15×8 м</h3></article></div></div></section>

      <section className="section gallery-section" id="gallery" aria-labelledby="gallery-title"><div className="wrap section-heading"><div><p className="eyebrow">Атмосфера</p><h2 className="display-title" id="gallery-title">Озеро, номера,<br />курортный день</h2></div><p className="section-aside">Ключевые кадры переведены на локальный медиапакет отеля: территория, номер и ночной Иссык-Куль. Неподтверждённые услуги не публикуются как CURRENT-факты.</p></div><ResortGallery images={galleryImages} /></section>

...
def capabilities() -> dict[str, bool]:
    return {
        ...
        "payment_operations": env_flag("ENABLE_PAYMENT_OPERATIONS", True),
        "service_point_qr": env_flag("ENABLE_SERVICE_POINT_QR", True),
        "mkassa": env_flag("ENABLE_MKASSA", True),
        "nfc_wallet": False,
    }
...
async def runtime_capabilities():
    values = capabilities()
    return {
        "profile": os.environ.get("LAUNCH_PROFILE", "FULL"),
        "capabilities": values,

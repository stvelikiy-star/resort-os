-- Three Crowns marketing foundation.
-- Marketing automation must fail closed: no outbound audience without an explicit latest OPTED_IN consent.
...
ALTER TABLE "marketing_consents"
  ADD CONSTRAINT marketing_consents_property_fkey FOREIGN KEY ("propertyId") REFERENCES properties(id) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT marketing_consents_request_fkey FOREIGN KEY ("requestId") REFERENCES reservation_requests(id) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT marketing_consents_guest_fkey FOREIGN KEY ("guestId") REFERENCES guests(id) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT marketing_consents_staff_fkey FOREIGN KEY ("createdByStaffId") REFERENCES staff_users(id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "marketing_touchpoints"
  ADD CONSTRAINT marketing_touchpoints_property_fkey FOREIGN KEY ("propertyId") REFERENCES properties(id) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT marketing_touchpoints_request_fkey FOREIGN KEY ("requestId") REFERENCES reservation_requests(id) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT marketing_touchpoints_guest_fkey FOREIGN KEY ("guestId") REFERENCES guests(id) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT marketing_touchpoints_staff_fkey FOREIGN KEY ("createdByStaffId") REFERENCES staff_users(id) ON DELETE SET NULL ON UPDATE CASCADE;
